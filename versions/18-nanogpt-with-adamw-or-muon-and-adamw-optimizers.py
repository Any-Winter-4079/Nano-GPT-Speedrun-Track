...
# torchrun --standalone --nproc_per_node=4 versions/18-nanogpt-with-adamw-or-muon-and-adamw-optimizers.py
...
betas = (0.9,0.95)
eps = 1e-8
max_lr = 5e-3 # 6e-4 | 1e-3 | 1.4e-3 | 1.8e-3 | 2.2e-3 | 2.6e-3 | 3e-3
