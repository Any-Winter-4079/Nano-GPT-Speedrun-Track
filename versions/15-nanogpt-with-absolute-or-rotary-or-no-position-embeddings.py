...
# torchrun --standalone --nproc_per_node=2 versions/15-nanogpt-with-absolute-or-rotary-position-embeddings.py
...
class GPTConfig:
    ...
    pos_encoding_type: str = "nope" # "rope", "nope", or any other name for "absolute"
